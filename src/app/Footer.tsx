    ...
    return (
        <footer className="flex flex-col sm:flex-row gap-6 sm:gap-0 sm:justify-around p-10 bg-primary text-primary-foreground text-sm">
            <nav className="flex flex-col gap-2">
                <header className="text-muted font-extrabold uppercase">Services</header>
            ...
            <nav className="flex flex-col gap-2">
                <header className="text-muted font-extrabold uppercase">Company</header>
            ...
            <nav className="flex flex-col gap-2">
                <header className="text-muted font-extrabold uppercase">Legal</header>
